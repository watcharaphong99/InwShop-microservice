...
const file_modules_auth_authPb_authPb_proto_rawDesc = "" +
	"\n" +
	" modules/auth/authPb/authPb.proto\x12\x06authpb\"8\n" +
	...
	"\x05count\x18\x01 \x01(\x03R\x05count2\x9e\x01\n" +
	"\x0fAuthGrpcService\x12O\n" +
	"\x11AccessTokenSearch\x12\x1c.authpb.AccessTokenSearchReq\x1a\x1c.authpb.AccessTokenSearchRes\x12:\n" +
	"\n" +
	"RolesCount\x12\x15.authpb.RolesCountReq\x1a\x15.authpb.RolesCountResBAZ?github.com/watcharaphong99/InwzaShop/modules/auth/authPb;authpbb\x06proto3"
...
var file_modules_auth_authPb_authPb_proto_goTypes = []any{
	(*AccessTokenSearchReq)(nil), // 0: authpb.AccessTokenSearchReq
	(*AccessTokenSearchRes)(nil), // 1: authpb.AccessTokenSearchRes
	(*RolesCountReq)(nil),        // 2: authpb.RolesCountReq
	(*RolesCountRes)(nil),        // 3: authpb.RolesCountRes
}
var file_modules_auth_authPb_authPb_proto_depIdxs = []int32{
	0, // 0: authpb.AuthGrpcService.AccessTokenSearch:input_type -> authpb.AccessTokenSearchReq
	2, // 1: authpb.AuthGrpcService.RolesCount:input_type -> authpb.RolesCountReq
	1, // 2: authpb.AuthGrpcService.AccessTokenSearch:output_type -> authpb.AccessTokenSearchRes
	3, // 3: authpb.AuthGrpcService.RolesCount:output_type -> authpb.RolesCountRes
