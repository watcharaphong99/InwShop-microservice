...
const (
	AuthGrpcService_AccessTokenSearch_FullMethodName = "/authpb.AuthGrpcService/AccessTokenSearch"
	AuthGrpcService_RolesCount_FullMethodName        = "/authpb.AuthGrpcService/RolesCount"
)
